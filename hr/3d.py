...
st.markdown('<p class="small-font">Adherencia: mide el % de personas con diagnóstico Vigente y excluidos (No Aplica 3D), con respecto al total del contrato</p>', unsafe_allow_html=True)
st.markdown('<p class="small-font">Desempeño: Mide el % de resultados Competentes, en comparación con el total de personas que deben ser evaluadas según su perfil</p>', unsafe_allow_html=True)